...
public class infoLines {
    ...
    static {
        ...
        MB.put("uncategorized", new ArrayList<>(new ArrayList<>(Arrays.asList("mb_games_played", "mb_wins", "mb_winstreak", "mb_points", "mb_hat"))));
        informationLines.put("MB", MB);

        LinkedHashMap<String, ArrayList<String>> UHC = new LinkedHashMap<>();
        UHC.put("uncategorized", new ArrayList<>(new ArrayList<>(Arrays.asList("uhc_points", "uhc_games_played", "uhc_wins", "uhc_kills", "uhc_deaths"))));
        ...
        event.put("SPLEEF", new ArrayList<>(Arrays.asList("spleef_games_played", "spleef_wins", "spleef_gold_earned", "spleef_blocks_broken", "spleef_snowballs_thrown", "spleef_most_blocks_broken")));
        event.put("SUMO", new ArrayList<>(Arrays.asList("sumo_games_played", "sumo_wins", "sumo_gold_earned", "sumo_kills", "sumo_most_kills")));
        event.put("SURVIVAL GAMES", new ArrayList<>(Arrays.asList("sg_games_played", "sg_wins", "sg_gold_earned", "sg_kills", "sg_deaths", "sg_chests_looted", "sg_most_kills")));
        event.put("TNT RUN", new ArrayList<>(Arrays.asList("tnt_run_games_played", "tnt_run_wins", "tnt_run_gold_earned", "tnt_run_walked_over_blocks", "tnt_run_leaps_used", "tnt_run_most_blocks_broken")));
